            ...
            <div class="flex flex-col sm:flex-row flex-wrap justify-between">
                ...
                <div class="sm:w-[30%] text-white pt-[18px] sm:pt-0">
                    ...
                    <nav class="flex justify-center pt-[18px]">
                        ...
                        <a href="https://www.facebook.com/drivingplates" target="_blank" class="w-8 h-[1.6rem] border-2 border-white box-border mx-1 rounded-md grid place-items-center relative left-[1.75px]" aria-label="DrivingPlates.com LLC">
                            <i class="fa-brands fa-facebook-f relative left-[1.5px]"></i>
                        </a>
                        <a href="https://www.linkedin.com/company/drivingplates-com" target="_blank" class="w-8 h-[1.6rem] border-2 border-white box-border mx-1 rounded-md grid place-items-center" aria-label="David Smith">
                            <i class="fa-brands fa-linkedin-in relative left-[1.5px]"></i>
                        </a>
                        <a href="https://twitter.com/drivingplates" target="_blank" class="w-8 h-[1.6rem] border-2 border-white box-border mx-1 rounded-md grid place-items-center" aria-label="DrivingPlates.com">
